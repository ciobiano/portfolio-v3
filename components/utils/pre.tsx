	...
	return (
		<>
			...
			<div className="flex gap-1 self-end mr-4 -mt-[2px]">
				<span
					data-language-tag
					className="text-accent bg-transparent-white border-grey b rounded-b-md px-2 inline-block max-w-fit cursor-default font-sans"
				>
					{language}
				</span>
				...
				<button
					...
					data-language-tag
					className="bg-primary text-black border  rounded-b-md px-2 inline-block max-w-fit hover:!bg-grey hover:text-primary transition-colors duration-200 ease-in-out"
				>
					Copy
				</button>
			</div>
